...
// Handlers to attach and unattach callbacks to notifications from server
...
export function removeAllListenersToServerEvent<T extends keyof IPC_PushNotification>
  (method: T): void {
